    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_event', models.ForeignKey(default=0, on_delete=django.db.models.deletion.SET_DEFAULT, to='organization.event')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, to='organization.organization')),
        ...
        migrations.AddField(
            ...
            name='settings',
            field=models.OneToOneField(default=0, on_delete=django.db.models.deletion.PROTECT, to='organization.orgsettings'),
        ),
    ]
