...
WSGI_APPLICATION = 'swiss.wsgi.application'
...
FORM_RENDERER = "swiss.settings.CustomFormRenderer"
...
if USE_MEDIA_SPACES:
    ...
    DEFAULT_FILE_STORAGE = 'swiss.storage_backends.MediaStorage'
